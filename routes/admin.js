...
router.post('/restaurants', adminAuth, isValidRestaurant, restaurantController.createRestaurant);
router.put('/restaurants/:restaurantId', adminAuth, isValidRestaurant, restaurantController.updateRestaurant);
